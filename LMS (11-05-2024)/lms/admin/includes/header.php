...
<div class="">
<div class="navbar navbar-inverse set-radius-zero bg-success" >
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    ...
                    <img src="assets\img\lms logo.png"  height=70 width=170/>
                </a>

            </div>

            <div class="right-div">
                <a href="logout.php" class="btn btn-danger pull-right"> EXIT Library </a>
            </div>
        </div>
    </div> 
    </div> 
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="dashboard.php" class="bg-white">DASHBOARD</a></li>
 ...
 <li>
                           ...
                           <li>
                             ...
                             <li><a href="reg-students.php">Regestered Students</a></li>
