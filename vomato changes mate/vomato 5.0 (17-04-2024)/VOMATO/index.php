                    ...
                    -------------------------------------------------------------------------------------
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
                                    ...
                                    echo  '<li class="nav-item"> <a class="nav-link active" href="user-profile.php"> Profile  <span class="sr-only"></span></a> </li>'; 
									echo  '<li class="nav-item btn btn-danger btn-sm text-light float-end btn-rounded"><a href="logout.php" class="nav-link active">Logout</a> </li>';
