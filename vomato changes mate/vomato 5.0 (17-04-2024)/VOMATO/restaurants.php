...
<head>
    ...
    <link rel="icon" href="#">
    <title>Restaurants || VOMATO-food ordering system</title>
...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links  bg-warning">
            <div class="container">
                <ul class="row links">
        ...
        <div class="inner-page-hero bg-image" data-image-src="images/img/horizon.jpg">
