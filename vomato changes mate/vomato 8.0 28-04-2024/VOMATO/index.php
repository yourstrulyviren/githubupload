...
<body class="home bg-info">
   ...
   <!--             <li class="nav-item btn btn-sm btn-outline-info"> <a class="nav-link active fa fa-home" href="index.php">Home <span class="sr-only">(current)</span></a> </li>  --> 
                   
                           
                        
                        <!-- btn btn-warning -----------btn btn-dark-------------active btn btn-secondary ---------------btn btn-light--------------------------------------- 
                    -- btn btn-info ------------ btn btn-primary---------------  fa fa-home ---------------fa fa-cutlery -----------------------------------------
                        -- fa fa-phone ------- fa fa-phone ------------fa fa-power-off ------- fa fa-sign-in  -----------------------------------------------------> 
						...
						if(empty($_SESSION["user_id"])) // if user is not login     
							{   
								...
								echo
                                 '  
                                  <li class="nav-item btn btn-warning btn-sm">  <a class="nav-link active fa fa-cutlery" href="restaurants.php">   Restaurants <span class="sr-only"></span></a> </li> 
                    
                                 <li class="nav-item btn btn-sm btn-secondary"><a href="aboutus.php" class="nav-link active fa fa-info">  About</a> </li>;    
                                       
                                 <li class="nav-item btn btn-success btn-sm"><a href="contactus.php" class="nav-link active fa fa-phone">  Contact Us</a> </li>;       
                              
                                 <li class="nav-item btn btn-sm btn-info"><a href="login.php" class="nav-link active fa fa-power-off">  Login</a> </li>      
                             
							  <li class="nav-item btn btn-sm btn-primary"><a href="registration.php" class="nav-link active fa fa-user-plus">  Sign Up</a> </li>';     
                         ...
                         echo      ' <li class="nav-item btn btn-outline-warning btn-sm"> <a class="nav-link active fa fa-cutlery" href="restaurants.php">Restaurants <span class="sr-only"></span></a> </li> ' ;
                                ...
                                echo  '<li class="nav-item btn btn-outline-primary btn-sm"><a href="your_orders.php" class="nav-link active fa fa-list-alt">My Orders</a> </li>';      
                                 echo 
                                    '<li class="nav-item btn btn-sm btn-outline-secondary"><a href="contactus.php" class="nav-link active fa fa-question-circle">Help</a> </li> ';   
                                    echo  '<li class="nav-item btn btn-sm btn-outline-info"> <a class="nav-link active fa fa-user" href="user-profile.php"> Profile  <span class="sr-only"></span></a> </li>'; 
    ...
    <section class="hero bg-image" data-image-src="images/img/q.jpg">
        <div class="hero-inner">  
            <div class="container text-center hero-text font-white">
                <h1> Order Food & Get Delivered </h1> 
						...
						$query_res= mysqli_query($db,"select * from dishes LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap active active-hover hover image-hover"> 
                                              <a>   <div class="figure-wrap active bg-image hovermate .hover-overlay  image-hover hover-image  img-hover  hover-imglink-active active" data-image-src="admin/Res_img/dishes/'.$r['img'].'"></div> </a>
                                                <div class="content">
   ...
   <!-- ------------------------------------------------------------------------------
    ...
    <section class="how-it-works bg-image" data-image-src="images/img/dark.jpg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Cash on Delivery Only</p>
                </div>
            </div>
        </div>
    </section>
