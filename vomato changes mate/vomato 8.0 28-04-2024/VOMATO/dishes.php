...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || VOMATO-food ordering system</title>
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"]))
							{
								echo ' 
                                <li class="nav-item btn-sm btn btn-secondary"> <a class="nav-link active fa fa-home" href="index.php">  Home <span class="sr-only">(current)</span></a> </li>
                            ...
                            <li class="nav-item btn btn-sm btn-outline-warning"> <a class="nav-link active fa fa-cutlery" href="restaurants.php">  Restaurants <span class="sr-only"></span></a> </li>'; 
